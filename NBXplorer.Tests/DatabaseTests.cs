...
namespace NBXplorer.Tests
{
	public class DatabaseTests
	{
		...
		{
			await using var conn = await GetConnection();
			var wk1 = PostgresRepository.nbxv1_get_wallet_id("BTC", "address1");
			var wk2 = PostgresRepository.nbxv1_get_wallet_id("BTC", "sWra[t1");
			var dk = PostgresRepository.nbxv1_get_descriptor_id("BTC", "strat1", "Deposit");
